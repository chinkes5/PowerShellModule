...
.LINK
https://learn.microsoft.com/en-us/rest/api/azure/devops/build/get?view=azure-devops-server-rest-5.0
#>
    [CmdletBinding()]
    param (
    ...
    try {
        Write-Verbose "Now fetching builds..."
